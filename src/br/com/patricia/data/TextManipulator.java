 ...
 * métodos que realizam a contagem das palavras para sentimentos positivos e
 * negativos, que serão utilizados posteriormente para os cálculos em
...
public class TextManipulator {
	...
	/**
	 * Conta o número de ocorrências de cada palavra para sentimentos positivos
	 * e negativos. As operações são realizadas em dois mapas, que podem ser
	 * retornados através dos getters and setters acima.
	 */
